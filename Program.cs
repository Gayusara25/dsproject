        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "C:\\Users\\Gayathri\\Desktop\\practice project\\dsdata1.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("C:\\Users\\Gayathri\\Desktop\\practice project\\dsdata2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("C:\\Users\\Gayathri\\Desktop\\practice project\\dsdata3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("C:\\Users\\Gayathri\\Desktop\\practice project\\dsdata1.txt").Split(' ');
